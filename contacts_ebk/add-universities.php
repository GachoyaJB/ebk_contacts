...
if ($_POST['submit']) {
	...
	$stmt->execute();
	echo "<script>alert('UniversityEntity has been added successfully');</script>";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add UniversityOrganization </h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add UniversityOrganization</div>
