...
check_login();
//code for adding County Govt Entities
if ($_POST['submit']) {
	$name = $_POST['n'];
	$designation = $_POST['d'];
	...
	$query = "insert into  countygovt (name,designation,entity_postaladdress,city,emailaddress,telno,website,personal_no,sector,contact_person) values(?,?,?)";
	...
	$stmt->execute();
	echo "<script>alert('County Government Entity has been added successfully');</script>";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add County Government Organization </h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add County Government Organization</div>
